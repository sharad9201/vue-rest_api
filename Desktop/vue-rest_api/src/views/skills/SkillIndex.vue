<script setup>
import useSkills from "../../components/skills";
        ...
        <tbody>
          ...
          >
            ...
            <td class="py-4 px-6 space-x-2">
                <RouterLink :to="{name: 'SkillEdit', params:{id:skill.id}}" class="px-4
              py-2
              bg-indigo-500
              hover:bg-indigo-700
              text-white
              rounded">Edit</RouterLink>
              <button @click="destroySkill(skill.id)" class="px-4
              py-2
              bg-red-500
              hover:bg-red-700
              text-white
